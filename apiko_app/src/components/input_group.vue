<template>
  <div class="login_item">
    <label>{{label}}</label>
    <input  :value="value"  @input="updateSelf($event.target.value)" :type="type" :placeholder="placeholder"/>
    <svg v-if="isShowSvg" @click="callBack"  class="is_show" width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
